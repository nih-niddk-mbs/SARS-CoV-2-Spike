...
"""
Compute the significance of the Standard deviation of the depths of selected Minima (SM) in coarse-grained
...
Find the minima (protein edges) located within w of specified center locations
...
Find the maxima (protein edges) located within w of specified center locations
...
mutate sequence S
insertions and deltions of desired length are put into Vectors
inserts and deletes
Number of substitutions are in subs
"""
